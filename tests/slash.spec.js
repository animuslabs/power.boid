...
describe("slash", async() => {
  describe("slashabsent", async() => {
    it("Success", async() => {
      ...
      await act("pwrreport", { oracle: "oracle4", boid_id_scope: boid_id, report: goodReport }, "oracle4")
      addRounds(3)
      await act("slashabsent", { oracle: "oracle5", protocol_id: 0, round: 16 })
    })
    describe("validate slashabsent checks", async() => {
      it("Oracle not found", async() => {
        await expectToThrow(
          act("slashabsent", { oracle: "oracle1", protocol_id: 0, round: 1 }),
      ...
      it("Oracle was not expected to be active this round", async() => {
        ...
        addRounds(3)
        await expectToThrow(
          act("slashabsent", { oracle: "oracle2", protocol_id: 0, round: 15 }),
      ...
      it("Oracle was active this round", async() => {
        ...
        addRounds(3)
        await expectToThrow(
          act("slashabsent", { oracle: "oracle2", protocol_id: 0, round: 16 }),
      ...
      it("Oracle is in standby, can't be slashed for inactivity", async() => {
        ...
        addRounds(3)
        await expectToThrow(
          act("slashabsent", { oracle: "oracle5", protocol_id: 0, round: 16 }),
  ...
  describe("slashoracle", async() => {
    it("Success", async() => {
      await act("protoset", { protocol: { protocol_id: 0, protocol_name: "testproto", unitPowerMult: 1, active:true } })
      await setupOracle("oracle1")
      await act("slashoracle", { oracle: "oracle1", protocol_id: 0, quantity: 10 })
    })
    describe("validate slashoracle checks", async() => {
      it("Oracle doesn't exist", async() => {
        await expectToThrow(
          act("slashoracle", { oracle: "oracle1", protocol_id: 0, quantity: 10 }),
      ...
      it("Quantity must be higher than zero", async() => {
        ...
        await setupOracle("oracle1")
        await expectToThrow(
          act("slashoracle", { oracle: "oracle1", protocol_id: 0, quantity: 0 }),
      ...
      it("Max collateral slashed reached", async() => {
        ...
        await act("slashoracle", { oracle: "oracle1", protocol_id: 0, quantity: 3000000000 })
        await expectToThrow(
          act("slashoracle", { oracle: "oracle1", protocol_id: 0, quantity: 1294967297 }),
