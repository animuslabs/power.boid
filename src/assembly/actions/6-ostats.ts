import { Action, ActionData, EMPTY_NAME, Name, check, print, requireAuth } from "proton-tsc"
...
export class OStatsActions extends DepositActions {
  ...
  payOracle(oracle:Name, basePay:u32, bonusPay:u32):void {
    ...
    this.sendWholeBoid(Name.fromString("tknmint.boid"), this.receiver, payQuantity, "payoracle")
