...
const tokenContract = "token.boid"
const methods = {
  async transfer(from, to, quantity_whole, memo) {
    await doAction("transfer", { from, to, quantity: `${parseInt(quantity_whole)}.0000 BOID`, memo }, tokenContract)
  }
}
